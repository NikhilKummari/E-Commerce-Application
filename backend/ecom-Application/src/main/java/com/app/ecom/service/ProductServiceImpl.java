...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductResponse searchByCategory(Long categoryId, Integer pageNumber, Integer pageSize, String sortBy, String sortOrder) {
        ...
        if(products.size() == 0){
            throw new APIException(category.getCategoryName() + " category does not have any product, Please add a product to this category");
        }
    ...
    public ProductDTO updateProductImage(MultipartFile image, Long productId) throws IOException {
        ...
        //upload image to file system and get the file name
